...
void onTriggerReceived(const OscMessage& m) {
  ...
  if (m.size() == 5) {
    ...
    debugmsg("received double trigger event >> id: " + String(id) + ", pulseWidth: "  + String(pulseWidth) + ", pulseFrequency: "  + String(pulseFrequency) + ", pulseStrength: "  + String(pulseStrength) + ", pulseDuration: "  + String(pulseDuration));
