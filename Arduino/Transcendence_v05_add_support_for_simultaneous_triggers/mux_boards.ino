...
void initTENSIDToBoardPortMapping() {
  ...
  // board 1
  id_to_boardport[7] = IdToBoardPort(0, 1);
  id_to_boardport[8] = IdToBoardPort(0, 2);

  // board 2
  id_to_boardport[1] = IdToBoardPort(1, 1);
  id_to_boardport[2] = IdToBoardPort(1, 2);
  id_to_boardport[3] = IdToBoardPort(1, 3);
  id_to_boardport[4] = IdToBoardPort(1, 4);
  id_to_boardport[5] = IdToBoardPort(1, 5);
  id_to_boardport[6] = IdToBoardPort(1, 6);
