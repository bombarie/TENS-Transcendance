...
void initTENSIDToBoardPortMapping() {
  ...
  id_to_boardport[2] = IdToBoardPort(0, 2);
  id_to_boardport[3] = IdToBoardPort(0, 3);
  id_to_boardport[4] = IdToBoardPort(0, 4);
  id_to_boardport[5] = IdToBoardPort(0, 5);
  id_to_boardport[6] = IdToBoardPort(0, 6);
  id_to_boardport[7] = IdToBoardPort(0, 7);
  id_to_boardport[8] = IdToBoardPort(0, 8);
