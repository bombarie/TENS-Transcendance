...
void draw() {
  ...
  drawBoard01Triggers(250, 20);
  drawBoard02Triggers(425, 20);
...
void drawBoard01Triggers(int x, int y) {
  ...
  btn_id_16.setPosition(x + 0, y + 150);
  btn_id_17.setPosition(x + 0, y + 175);
  btn_id_18.setPosition(x + 0, y + 200);
  btn_id_19.setPosition(x + 0, y + 225);
  btn_id_20.setPosition(x + 0, y + 250);
...
void drawBoard02Triggers(int x, int y) {
  ...
  btn_id_09.setPosition(x + 0, y + 100);
  btn_id_10.setPosition(x + 0, y + 125);
  btn_id_11.setPosition(x + 0, y + 150);
  btn_id_12.setPosition(x + 0, y + 175);
  btn_id_13.setPosition(x + 0, y + 200);
  btn_id_14.setPosition(x + 0, y + 225);
  btn_id_15.setPosition(x + 0, y + 250);
  btn_id_21.setPosition(x + 0, y + 275);
